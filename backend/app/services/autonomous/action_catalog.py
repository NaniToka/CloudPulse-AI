...
ACTION_REGISTRY: dict[str, ActionDefinition] = {
    ...
    "SERVICE_RESTART": ActionDefinition(
        action_type="SERVICE_RESTART",
        domain="INCIDENT",
        provider="AWS",
        risk_level="MEDIUM",
        description="Restart microservice or service instance.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "POD_RESTART": ActionDefinition(
        action_type="POD_RESTART",
        domain="KUBERNETES",
        provider="Kubernetes",
        risk_level="LOW",
        description="Restart Kubernetes pod instance.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "SCALE_UP": ActionDefinition(
        action_type="SCALE_UP",
        domain="CAPACITY",
        provider="Kubernetes",
        risk_level="MEDIUM",
        description="Scale workload replicas up to accommodate traffic demand.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "SCALE_DOWN": ActionDefinition(
        action_type="SCALE_DOWN",
        domain="FINOPS",
        provider="Kubernetes",
        risk_level="MEDIUM",
        description="Scale workload replicas down to reduce cost.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "CLEAR_CACHE": ActionDefinition(
        ...
        provider="AWS",
        risk_level="LOW",
        description="Clear operational caches and ephemeral storage.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=False,
    ...
    "ROTATE_CONFIGURATION": ActionDefinition(
        ...
        provider="Kubernetes",
        risk_level="MEDIUM",
        description="Rotate workload secret or configuration parameters.",
        required_permissions=["Security.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "DISABLE_UNHEALTHY_INSTANCE": ActionDefinition(
        action_type="DISABLE_UNHEALTHY_INSTANCE",
        domain="INCIDENT",
        provider="AWS",
        risk_level="HIGH",
        description="Disable or quarantine degraded compute instance.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "RESTART_WORKLOAD": ActionDefinition(
        action_type="RESTART_WORKLOAD",
        domain="KUBERNETES",
        provider="Kubernetes",
        risk_level="MEDIUM",
        description="Perform rolling restart of workload pods.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "ADJUST_RESOURCE_LIMIT": ActionDefinition(
        action_type="ADJUST_RESOURCE_LIMIT",
        domain="CAPACITY",
        provider="Kubernetes",
        risk_level="MEDIUM",
        description="Adjust container CPU/memory resource limits.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "CHANGE_REPLICA_COUNT": ActionDefinition(
        action_type="CHANGE_REPLICA_COUNT",
        domain="CAPACITY",
        provider="Kubernetes",
        risk_level="MEDIUM",
        description="Modify target deployment replica count.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "PAUSE_IDLE_RESOURCE": ActionDefinition(
        action_type="PAUSE_IDLE_RESOURCE",
        domain="FINOPS",
        provider="AWS",
        risk_level="HIGH",
        description="Pause unutilized cloud resource to stop waste.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "ENABLE_AUTOSCALING": ActionDefinition(
        action_type="ENABLE_AUTOSCALING",
        domain="CAPACITY",
        provider="Kubernetes",
        risk_level="LOW",
        description="Enable Horizontal Pod Autoscaler for workload.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=True,
    ...
    "CREATE_ALERT": ActionDefinition(
        ...
        provider="AWS",
        risk_level="LOW",
        description="Generate cloud monitoring alert.",
        required_permissions=["Incidents.Manage"],
        supports_dry_run=True,
        supports_simulation=True,
        supports_rollback=False,
