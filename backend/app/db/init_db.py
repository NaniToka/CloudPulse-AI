...
async def init_db(db: AsyncSession) -> None:
    ...
    try:
        ...
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS resource_id VARCHAR(255);"))
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS environment VARCHAR(50) DEFAULT 'production';"))
        ...
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS acknowledged_at TIMESTAMP WITH TIME ZONE;"))
        ...
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS mttr_seconds FLOAT;"))
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS sla_target_seconds INTEGER DEFAULT 1800;"))
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS sla_status VARCHAR(50) DEFAULT 'PENDING';"))
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS correlation_score FLOAT DEFAULT 0.94;"))
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS fingerprint VARCHAR(64);"))
        ...
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS ai_analysis JSON DEFAULT '{}';"))
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS analysis_engine VARCHAR(50) DEFAULT 'local';"))
        ...
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS resolution_verified BOOLEAN DEFAULT FALSE;"))
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS verification_evidence JSON DEFAULT '[]';"))
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS remaining_risk VARCHAR(50) DEFAULT 'NONE';"))
        await db.execute(text("ALTER TABLE incidents ADD COLUMN IF NOT EXISTS verified_at TIMESTAMP WITH TIME ZONE;"))
        ...
        # Security scans table migrations
        await db.execute(text("ALTER TABLE security_scans ADD COLUMN IF NOT EXISTS resource_type VARCHAR(100) DEFAULT 's3_bucket';"))
        await db.execute(text("ALTER TABLE security_scans ADD COLUMN IF NOT EXISTS category VARCHAR(100) DEFAULT 'Storage';"))
        await db.execute(text("ALTER TABLE security_scans ADD COLUMN IF NOT EXISTS compliance_framework VARCHAR(100) DEFAULT 'CIS';"))
        await db.execute(text("ALTER TABLE security_scans ADD COLUMN IF NOT EXISTS risk_score FLOAT DEFAULT 7.5;"))
        await db.execute(text("ALTER TABLE security_scans ADD COLUMN IF NOT EXISTS confidence FLOAT DEFAULT 0.90;"))
        await db.execute(text("ALTER TABLE security_scans ADD COLUMN IF NOT EXISTS evidence JSON DEFAULT '[]';"))
