...
class ServerMetric(UUIDMixin, Base):
    ...
    # Relationship
    server: Mapped[Server] = relationship("Server", back_populates="metrics", lazy="raise")
...
class InfraAlert(UUIDMixin, TimestampMixin, Base):
    ...
    # Relationship
    server: Mapped[Server] = relationship("Server", back_populates="infra_alerts", lazy="raise")
