...
import { ShieldCheck, RefreshCw, Sparkles, Server, Layers } from 'lucide-react';
import { ReliabilityFilterParams } from '../../services/reliabilityService';

interface ReliabilityHeaderProps {
  filters: ReliabilityFilterParams;
  onFilterChange: (filters: ReliabilityFilterParams) => void;
  onRefresh: () => void;
  onAnalyze: () => void;
  loading: boolean;
  analyzing: boolean;
...
export const ReliabilityHeader: React.FC<ReliabilityHeaderProps> = ({
  filters,
  onFilterChange,
  onRefresh,
  onAnalyze,
      ...
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-2xl font-extrabold text-white tracking-tight">
                Service Reliability Center & SLO Intelligence 2.0
              </h1>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Active Service Reliability Engineering layer continuously evaluating SLOs, error budgets, multi-window burn rates & risks.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
          ...
          >
            ...
            {analyzing ? 'Analyzing Reliability...' : 'Trigger SRE Analysis'}
          </button>
